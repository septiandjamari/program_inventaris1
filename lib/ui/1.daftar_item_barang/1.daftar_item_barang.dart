...
import 'package:program_inventaris/ui/1.daftar_item_barang/2.form_item_barang.dart';
import 'package:shared_preferences/shared_preferences.dart';

class DaftarItemBarang extends StatefulWidget {
  const DaftarItemBarang({Key? key}) : super(key: key);

  @override
  State<DaftarItemBarang> createState() => _DaftarItemBarangState();
}

class _DaftarItemBarangState extends State<DaftarItemBarang> {
  int itemShow = 10;
  int currentPage = 0;
  int firstPage = 0;
  int lastPage = 0;
  ...
  void loadDaftarItemBarangValue() async {
    await Future.delayed(const Duration(seconds: 1));
    var initialData = await streamDaftarItemBarangProvider.daftarItemBarangValue(addEditDeleteViewListDaftarBarang: "list");
    var daftarLokasiResult = await streamMasterLokasiProvider.masterLokasiValue(addEditDeleteViewListMasterLokasi: "list");
    setState(() {
      daftarItemBarang = initialData;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<Map<String, dynamic>>>(
      stream: streamDaftarItemBarangProvider.getStream,
      initialData: daftarItemBarang,
                              ...
                              child: TextButton(
                                onPressed: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => const FormItemBarang(addViewEdit: "add"),
                                    ),
                                  );
                                },
                      ...
                      title: Row(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            width: MediaQuery.of(context).size.width * 0.250,
                            child: Text("${e["kodeitem"]}", style: const TextStyle(color: Colors.black)),
                          ),
                          Container(
                            padding: const EdgeInsets.only(right: 10),
                            width: MediaQuery.of(context).size.width * 0.275,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(
                                width: MediaQuery.of(context).size.width * 0.250,
                                child: const Text("Tahun\nPembelian", style: TextStyle(fontWeight: FontWeight.bold)),
                              ),
                              SizedBox(
                                width: MediaQuery.of(context).size.width * 0.275,
                                child: const Text("Lokasi", style: TextStyle(fontWeight: FontWeight.bold)),
                              ),
                              SizedBox(
                                width: MediaQuery.of(context).size.width * 0.275,
                                child: const Text("Kondisi", style: TextStyle(fontWeight: FontWeight.bold)),
                              ),
                            ],
                          ),
                        ),
                              ...
                              child: TextButton.icon(
                                ...
                                onPressed: () {
                                  ...
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => FormItemBarang(addViewEdit: "view", idBarang: e["kodeitem"]),
                                    ),
                                  );
                                },
                                        ...
                                        child: TextButton.icon(
                                          ...
                                          onPressed: () {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                                builder: (context) => FormItemBarang(addViewEdit: "edit", idBarang: e["kodeitem"]),
                                              ),
                                            );
                                          },
